...
Conventional commit from the staged diff — follows `.Codex/rules/git-workflow.md`.
...
2. Pick the single `<type>` that fits per `.Codex/rules/git-workflow.md`. Never combine types.
