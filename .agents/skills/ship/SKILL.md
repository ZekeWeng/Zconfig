...
Sync, test, push, and open a draft PR — applies `.Codex/rules/git-workflow.md` and `working-style.md`.
...
4. **Self-review.** Run `git diff origin/$default..HEAD`. Apply the "Surgical changes" test from `.Codex/rules/working-style.md` — every changed line should trace to the user's request. Confirm:
